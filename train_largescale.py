...
from face_pre_pro.ViT_face import face_landmark_4simmin_glo_loc, ViT_face_landmark_patch8,PBSQ_ViT_Part_face
...
if __name__ == '__main__':
    ...
    parser.add_argument("-w", "--workers_id", help="gpu ids or cpu", default='0', type=str)#3,4,7
    parser.add_argument("-e", "--epochs", help="training epochs", default=80, type=int)#125#35
    parser.add_argument("-b", "--batch_size", help="batch_size", default=82, type=int)#480,350#275#66 #76  80-84 176 na:160 pandora:400  tiny:240  #320
    ...
    parser.add_argument("-r", "--resume", help="resume model", default='/public/home/ncu_418000240023/LAFS2/webface_196land_sp.pth', type=str)
    
    
    parser.add_argument( "--pretrain_path", help="pretrain_path is the supervised model from stage 1", default='/public/home/ncu_418000240023/LAFS2/webface_196land_sp.pth', type=str)
    parser.add_argument( "--model_dir", help="model_dir is the self-supervised model from stage 2(LAFS)", default='/public/home/ncu_418000240023/new_LAFS/SSL_Webface_webland_partViTB.pth', type=str)
    parser.add_argument( "--dataset_path", help="dataset_path is the path to the rec file (MS1M, WebFace4m)", default='/public/home/ncu_418000240023/LAFS2/data/webface24m_test_4m10shot', type=str)
    parser.add_argument( "--eval_root", help="eval_root is the path to the evaluation files, using validation files from MS1MV3 ", default='/public/home/ncu_418000240023/LAFS_CVPR2024-main/data/ms1m-retinaface-t1/ms1m-retinaface-t1/', type=str)

    
    
    parser.add_argument('--outdir', help="output dir", default='/public/home/ncu_418000240023/new_LAFS/LAFS_CVPR2024-main/LAFS_CVPR2024-main/results/1%_10shot_20251024_PBSQ_Coattention_10shot', type=str)
    ...
    parser.add_argument('--lr', type=float, default=1e-4, metavar='LR',#2.9e-4,7.5e-5 1e-3#sgd 5e-4  #5e-5 layerwise 1e-4?
    ...
    dataset = FaceDataset(os.path.join(args.dataset_path, 'train.rec'), 
                          rand_mirror=True,
                          random_resizecrop=True,
                          rand_au=True,
    ...
    scheduler=torch.optim.lr_scheduler.CosineAnnealingLR(OPTIMIZER,T_max= max_steps, eta_min=1e-4)#optimizer_stn,optimizer
